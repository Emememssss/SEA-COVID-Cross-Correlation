...
%    Worksheet: Sheet2
%
% Auto-generated by MATLAB on 01-Feb-2022 17:22:57
...
subplot(2,3,1); plot(ChinaNewCases); title('China New Cases');
subplot(2,3,2); plot(PhNewCases); title('Ph New Cases');
subplot(2,3,3); plot(IndiaNewCases); title('India New Cases');

subplot(2,3,4); plot(ChinaNewCasesPct); title('% Change');
subplot(2,3,5); plot(PhNewCasesPct); title('% Change');
subplot(2,3,6); plot(IndiaNewCasesPct); title('% Change');
...
[rhooriginal1,pvaloriginal1] = corr(PhNewCasesPct,ChinaNewCasesPct,'type','Pearson');
[rhooriginal2,pvaloriginal2] = corr(PhNewCasesPct,IndiaNewCasesPct,'type','Pearson');
[rhooriginal3,pvaloriginal3] = corr(ChinaNewCasesPct,IndiaNewCasesPct,'type','Pearson');
